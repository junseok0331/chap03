...
/**
 * Caulculator 클래스를 객체로 생성해서 사용하는 실행클래스
...
public class CalculatorMain {
	public static void main(String[] args) {
		...
		//  전달 받는 값이 없으므로 메소드만 호출하면됨.
		myCalc.powerOn();
		
		//3. 덧셈
		//3-1 덧셈 메소드 호출하면서 인자값으로 5와6을 전달
		...
		//7. 뺄셈
		int result11 =myCalc.subtraction(x, y);
		System.out.println("뺄셈 결과 : " + result11);
